...
function getSystemParams() {
  let nivel0_old = nivel0;
  let hrep_old = hrep;
  let altura_old = altura;
  ...
  hrep = map(hrep, 0, altura_old - nivel0_old, 0, altura - nivel0);
  hsaida = map(
    hsaida,
    0,
    altura_old - nivel0_old - hrep_old,
    0,
    altura - nivel0 - hrep
  );
  nivel = map(nivel, nivel0_old + hrep_old, altura_old, nivel0 + hrep, altura);
  ...
  Params.valvula1 = {
    ...
    largura:
      valvula1Mult * canvasW - Params.joelho1.posx - Params.joelho1.largura,
    w: 15 * yscale,
  ...
  Params.cano1 = {
    ...
    largura:
      cano1Mult * canvasW - (Params.valvula1.posx + Params.valvula1.largura),
    w: 15 * yscale,
    flange1: 1,
    flange2: 1,
  };
  ...
  Params.cano2 = {
    ...
    largura:
      Params.joelho2.posy -
      (altura - nivel0 - hrep - hsaida + 15 * yscale + 32.5 * yscale),
    w: 15 * yscale,
    flange1: 1,
    flange2: 1,
    ang: -90,
  ...
  Params.canoEntradaTanque2 = {
    ...
    largura:
      canoEntradaMult * canvasW -
      (Params.joelho3.posx + Params.joelho3.largura),
    w: 15 * yscale,
    flange1: 1,
    flange2: 0,
  };
  ...
  Params.saidaAgua1 = {
    posx:
      Params.canoEntradaTanque2.posx +
      Params.canoEntradaTanque2.largura -
      25 * yscale,
  ...
  let cityPosy =
    Params.tanqueRep.posy -
    Params.tanqueRep.altura +
  ...
  let cano3W =
    cityPosx - Params.joelho4.posx - Params.joelho4.largura + Params.joelho4.w;
  let cano3Angle = 0;
  if (canvasW <= respLim[0]) {
    cano3W = -(
      cityPosx +
  ...
  let watt1Y =
    Params.tanqueRep.posy - Params.tanqueRep.altura + wattMult * canvasW;
